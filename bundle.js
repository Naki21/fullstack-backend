...
/***/ function(module, exports, __webpack_require__) {
	...
	var fighterEvents = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).catch(ui.failure);
	...
	var onChangePassword = function onChangePassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.changePassword(data).catch(ui.failure);
	};
	//There is a better way to log out individual player
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut(store.user).then(ui.signOutSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1>Battle Gifs</h1>\n<p class=\"lead\">You must be signed in to play.</p>\n<!-- Choose fighter display and set-->\n<div id=\"fighterDisplay\">\n<button type=\"button\" id=\"get-fighter-button\" class=\"btn btn-primary btn hidden\">Get New Fighter</button>\n</div>\n<!-- /Choose fighter display and set-->\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllFighters = function getAllFighters() {
	  api.getAllFighters().then(ui.getAllFightersSuccess).catch(ui.failure);
	};

	// Gets a random fighter from the Giphy api through my api
	var getRandomFighter = function getRandomFighter() {
	  api.randomFighter().then(ui.getRandomSuccess).catch(ui.failure);
	};

	// Creates a new fighter instance which references the url of the giphy instance
	var setRandomFighter = function setRandomFighter() {
	  api.postFighters().then(ui.setRandomSuccess).catch(ui.failure);
	};

	// Deletes fighter by its associated id
	var deleteFighter = function deleteFighter() {
	  var id = $(this).data().fighterId;
	  api.deleteFighter(id).then(ui.deleteFighterSuccess(id)).catch(ui.failure);
	};
	...
	var createBattle = function createBattle() {
	  ...
	  api.postBattle().then(ui.createBattleSuccess).catch(ui.failure);
	};
	var detWin = function detWin() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var randomFighter = function randomFighter() {
	  return $.ajax({
	...
	var deleteFighter = function deleteFighter(id) {
	  return $.ajax({
	...
	var postFighters = function postFighters() {
	  return $.ajax({
	    url: app.host + "/fighters",
	    method: 'POST',
	    headers: {
	...
	var postBattle = function postBattle() {
	  return $.ajax({
	...
	var updateBattle = function updateBattle(win) {
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(5);
	var showRandomFighter = __webpack_require__(32);
	var showFightBox = __webpack_require__(33);
	var showFighterIndex = __webpack_require__(34);
	var battle_button = __webpack_require__(35);
	var play_again = __webpack_require__(36);

	var failure = function failure(error) {
	  console.error(error);
	};

	var getAllFightersSuccess = function getAllFightersSuccess(fighters) {
	...
	var deleteFighterSuccess = function deleteFighterSuccess(id) {
	  id = "#fighter-" + id;
	  $(id).hide();
	};
	var setRandomSuccess = function setRandomSuccess(data) {
	...
	var createBattleSuccess = function createBattleSuccess(data) {
	  var oppo = data.battle;
	...
	var winState = function winState(win) {
	  if (win === true) {
	...
	module.exports = {
	  deleteFighterSuccess: deleteFighterSuccess,
	  winState: winState,
	  getAllFightersSuccess: getAllFightersSuccess,
	  createBattleSuccess: createBattleSuccess,
	  setRandomSuccess: setRandomSuccess,
	  getRandomSuccess: getRandomSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"container-fluid\" id=\"fightbox\">\n  <div class=\"row\">\n    <div class=\"col-sm-offset-1 col-sm-4 \"><img class=\"img-rounded img-responsive\" src=\""
	    + alias4(((helper = (helper = helpers.my_fighter || (depth0 != null ? depth0.my_fighter : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"my_fighter","hash":{},"data":data}) : helper)))
	    + "\" alt=\"Responsive image\"></div>\n\n    <div class=\"col-sm-2\">V.S.</div>\n    <div class=\"col-sm-4 \"><img src=\""
	    ...
	    + "\" id=\"opponent\" class=\"img-rounded img-responsive\" alt=\"Responsive image\"></div>\n  </div>\n  <hr>\n  <button type=\"button\" id=\"calc-win-button\" class=\"btn btn-primary btn\">Fight!!</button>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col-lg-3 col-md-4 col-xs-6 thumb\" id=\"fighter-"
	    ...
	    + "\" alt=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\">\n      <button type=\"button\" id=\"create-battle-button\" data-fighter-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class=\"btn btn-success btn-xs\">Set</button>\n      <button type=\"button\" data-fighter-id='"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "' class=\"btn btn-danger btn-xs\">Delete</button>\n\n    </a>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"col-lg-12\">\n  <h1 class=\"page-header\">Your Barracks</h1>\n  <p> Here you can set your current fighter or delete them</p>\n</div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.fighters : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "<div class=\"col-xs-12\">\n  <hr>\n<button type=\"button\" id=\"get-fighter-button\" class=\"btn btn-primary btn\">Get New Fighter</button>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button type='button' id='create-battle-button' class='btn btn-primary btn'>Begin</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button type=\"button\" id=\"create-battle-button\" class=\"btn btn-primary btn\">Play again?</button>\n<button type=\"button\" id=\"get-fighter-button\" class=\"btn btn-primary btn\">Get New Fighter</button>\n<button type=\"button\" id=\"get-all-fighter-button\" class=\"btn btn-primary btn\">Your Barracks</button>\n";
	},"useData":true});
